"""
Файл отвечает за фильтрацию изображений перед публикацией.

🔹 Генерация хеша: Позволяет определять дубликаты изображений.
🔹 Проверка на лица: Исключает изображения с людьми, используя OpenCV.
🔹 Логирование: Записывает обработанные изображения и ошибки загрузки.
"""
